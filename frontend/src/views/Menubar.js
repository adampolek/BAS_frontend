...
const Menubar = ({color = 'purple' , ...props}) => {
    return (
        <JAMHamburger color={color}>
            ...
            <JAMButton theme={color!='purple' ? 'white' : 'normal'} value='Daily diagnosis' width='300px' onClick={()=>window.location='diagnosis'}/>
            <JAMLine style={{marginTop: '20px', marginBottom: '20px'}}/>
            {/* TODO: ŻYŻO, tu trzeba obsłużyć i wyświetlić panel jak admin :) */}
